...
"""Functions that handle saving and loading of checkpoints_32x2_r100."""
...
def make_checkpoint_dir(path_to_job):
    ...
    """
    checkpoint_dir = os.path.join(path_to_job, "checkpoints_32x2_r100")
...
def get_checkpoint_dir(path_to_job):
    """
    Get path for storing checkpoints_32x2_r100.
    Args:
        path_to_job (string): the path to the folder of the current job.
    """
    return os.path.join(path_to_job, "checkpoints_32x2_r100")
...
def get_last_checkpoint(path_to_job, task):
    ...
    if len(names) == 0:
        return None
    # Sort the checkpoints_32x2_r100 by epoch.
    name = sorted(names)[-1]
...
def save_checkpoint(path_to_job, model, optimizer, epoch, cfg, scaler=None):
    ...
    """
    # Save checkpoints_32x2_r100 only from the master process.
